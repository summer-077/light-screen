  ...
  <div class="main_container">
    <div class="top_energy">
      ...
      <el-alert
        ...
        type="warning"
        :closable="false"
        description="当前时间段路灯没有通电，处于非工作状态"
        show-icon>
      </el-alert>
    </div>
...
export default {
  ...
  methods: {
    ...
    watch(resp) {
      console.log("this.$refs.auto",this.$refs.auto);
      console.log("this.$refs.energy",this.$refs.energy);
      console.log("this.$refs.manual",this.$refs.manual);
